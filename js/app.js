...
showResultsBtn.addEventListener('click', () => {
  ...
  const firms = (BRAND_FIRMS[dataKey] || []).filter(f => !f.city || f.city === city);
...
function yardimSortedByDistance(list) {
  ...
  return [...list].sort((a, b) => distanceKmYardim(userCoords, a) - distanceKmYardim(userCoords, b));
}
