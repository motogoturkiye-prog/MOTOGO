...
function renderSubcatGrid() {
  ...
  // Sıra: Servis, Bayi, Yol Yardım (3.), sonra kalanlar
  subcatGrid.appendChild(buildSubcatChip(SUBCATS[0]));
  subcatGrid.appendChild(buildSubcatChip(SUBCATS[1]));
  subcatGrid.appendChild(buildYardimChip());
  SUBCATS.slice(2).forEach(sc => subcatGrid.appendChild(buildSubcatChip(sc)));
}
