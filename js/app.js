...
(function(){
  ...
  function renderHatirlatici(el){
    ...
    el.innerHTML =
      ...
      '<label>Son Yağ Değişimi Tarihi</label>' +
      '<input type="date" id="hubYag" value="' + (saved.yag || '') + '">' +
    ...
    function durumYaz(){
      var d = { yag: document.getElementById('hubYag').value, muayene: document.getElementById('hubMuayene').value, sigorta: document.getElementById('hubSigorta').value };
      var lines = [];
      [['yag','Yağ değişimi'], ['muayene','Muayene'], ['sigorta','Sigorta']].forEach(function(pair){
