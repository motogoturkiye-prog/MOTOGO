    ...
    if (window.motogoSupabase) {
      ...
      window.motogoSupabase.from('firma_basvurulari').insert({
        ...
        if (error) {
          ...
          durum.innerHTML = '✅ Başvurunuz alındı.<br><a href="https://www.motogoprime.com/pricing-plans/plans-pricing" target="_blank" style="color:var(--red);font-weight:700;">Paketleri İncele ve Öde →</a>';
          durum.style.color = '#9a9aa2';
        }
      });
    } else {
